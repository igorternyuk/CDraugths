...
namespace view
{
    ...
    private:
        ...
        const std::string _sMenuTitleGameType = "WELCOME TO THE GAME OF DRAUGHTS!";
        ...
        const DrawHelper::Color _colorTileDark = {93, 162, 45};
        const DrawHelper::Color _colorTileCoronation= {174, 107, 59};
        ...
        const DrawHelper::Color _colorMenuTitle2 = {21, 37, 130};
